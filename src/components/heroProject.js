  ...
  return (
    <div className="flex flex-col sm:flex-row sm:flex-wrap mx-auto max-w-screen-lg  ">
      <div className="pt-10 p-1 sm:p-4">
        <h2
          className="text-4xl flex justify-center sm:text-5xl md:text-6xl lg:text-[8rem] xl:text-[8rem] 2xl:text-8xl tracking-tight max-w-full tracking-tight pb-4"
          style={{
        ...
        <section className="flex justify-center items-center p-1 sm:p-4 min-h-[200px] sm:min-h-[400px]">
          <a href="https://wickedsignfab.com/">
            <img
              ...
              className="rounded-lg shadow-lg border-white p-4 border-4 mx-auto w-full object-contain w-full sm:max-w-[90%] md:max-w-[1100px] hover:scale-110 transition-all duration-300"
            />
          </a>
        </section>
      </div>
